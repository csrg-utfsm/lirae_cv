...
\cventry{NRAO AUI}{Convenio especial de colaboración científica y técnica entre Associated Universities, INC. y la Univerdidad Técnica Federico Santa María}{Proveer apoyo ténico en las tareas del subsistema Scheduling de Computing Integrated Product Team (CIPT). Estas tareas fueron prestadas por personal de nivel académico equivalente a profesores auxiliares o asociados en Ingeniería Informática}{Colaboración: UTFSM, NRAO}{Productos: Confidenciales}{Valparaíso, 2010}
...
\cventry{FeriaSW}{Taller de Ingeniería de Software}{En este curso se han realizado varios productos en el marco del equipo LIRAE. El curso consiste en desarrollar un producto de software con un cliente real}{Productos: Hevelius, LegoFARM, ALMA Lego Simulator}{}{}
